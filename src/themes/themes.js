...
export const THEMES = [
  ...
  },
  {
    id: "solarpunk",
    name: "Solarpunk",
    description: "Sunny skies, rolling hills, bountiful harvests, and robots tending the gardens.",
    scheme: "light",
    ...
    tokens: {
      ...
      "glass-2": "oklch(0.965 0.03 115 / 0.62)",
    },
  },
  {
    id: "cyberpunk",
    name: "Cyberpunk",
    description: "Neon on midnight, animated borders, and hologram chat boxes.",
    scheme: "dark",
    ...
    tokens: {
      ...
      glass: "oklch(0.16 0.04 285 / 0.64)",
